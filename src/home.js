...
export default function Home({ loginStatus }) {
  ...
  return (
    <div style={{ color: "white" }}>
      ...
      <footer className="pt-5 pb-4" style={{ backgroundColor: "#0a0a0a" }}>
        <div className="container">
          <div className="row g-4 mb-4">
            <div className="col-lg-4 mb-4 mb-lg-0">
              <h3 className="fs-4 fw-bold mb-4" style={{ color: "#ff3333" }}>
                Blacknykee
              </h3>
              <p className="mb-4">
            ...
            <div className="col-sm-6 col-lg-2">
              <h5 className="fs-6 fw-bold mb-3">Shop</h5>
            ...
            <div className="col-sm-6 col-lg-2">
              <h5 className="fs-6 fw-bold mb-3">Legal</h5>
              <ul className="list-unstyled">
                <li className="mb-2">
                  <a href="#" className="text-secondary text-decoration-none">
                    Privacy Policy
